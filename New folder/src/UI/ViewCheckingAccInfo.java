 ...
 * @author admin
 */
public class ViewCheckingAccInfo extends javax.swing.JPanel {

    CheckingAccount checkingAccount;
    /**
     * Creates new form viewDemographicInformation
     */
    public ViewCheckingAccInfo(CheckingAccount checkingAccount) {
        initComponents();
    ...
    txtBankAccountNumber.setText(checkingAccount.getBankRoutinNumber());
    txtRoutingNumber.setText(checkingAccount.getBankRoutinNumber());
    txtBankName.setText(checkingAccount.getBankName());
    txtAccountBalance.setText(checkingAccount.getAccountBalance());
}
}
